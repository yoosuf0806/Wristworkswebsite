...
insert into public.products
  (slug, name, brand, categories, reference, description, price, offer_price, stock, featured, new_arrival, rating_average, rating_count, attributes, meta_title, meta_description, focus_keyword)
values
  ('casio-g-shock-ga-2100-carbon-core', 'G-Shock GA-2100 Carbon Core', 'Casio', '{"mens-watches","digital-watches","analog-watches"}', 'GA-2100-1A1', 'The GA-2100 pairs Casio''s Carbon Core Guard case with a slim octagonal bezel — the ''CasiOak'' silhouette that put G-Shock on every wrist. Analog-digital display, 200m water resistance and shock resistance in a package under 12mm thick.', 64500, 51500, 12, true, true, 4.8, 42, '{"display":"Ana-Digi","style":"Sports","caseColor":"Black","dial":"Black","features":["World Time"],"collection":"G-Shock"}'::jsonb, 'Casio G-Shock GA-2100 Carbon Core — Buy Authentic in Sri Lanka', 'Genuine Casio G-Shock GA-2100 Carbon Core — 100% authentic with full warranty and island-wide delivery in Sri Lanka.', 'g-shock-ga-2100-carbon-core sri lanka')
on conflict (slug) do update set
  name = excluded.name, brand = excluded.brand, categories = excluded.categories,
  reference = excluded.reference, description = excluded.description, price = excluded.price,
  offer_price = excluded.offer_price, stock = excluded.stock, featured = excluded.featured,
  new_arrival = excluded.new_arrival, rating_average = excluded.rating_average,
  rating_count = excluded.rating_count, attributes = excluded.attributes,
...
insert into public.products
  (slug, name, brand, categories, reference, description, price, offer_price, stock, featured, new_arrival, rating_average, rating_count, attributes, meta_title, meta_description, focus_keyword)
values
  ('casio-mdv-106-duro-diver', 'MDV-106 Duro Diver', 'Casio', '{"mens-watches","analog-watches","dive-watches"}', 'MDV-106-1A', 'The ''Duro'' — Casio''s 200m diver on a steel bracelet with a Submariner-style dial and a price that makes it the best value in dive watches. A genuine tool watch.', 32500, null, 10, true, false, 4.8, 47, '{"display":"Analog","style":"Dive","caseColor":"Black","dial":"Black","features":[],"collection":"MDV Series"}'::jsonb, 'Casio MDV-106 Duro Diver — Buy Authentic in Sri Lanka', 'Genuine Casio MDV-106 Duro Diver — 100% authentic with full warranty and island-wide delivery in Sri Lanka.', 'mdv-106-duro-diver sri lanka')
on conflict (slug) do update set
  name = excluded.name, brand = excluded.brand, categories = excluded.categories,
  reference = excluded.reference, description = excluded.description, price = excluded.price,
  offer_price = excluded.offer_price, stock = excluded.stock, featured = excluded.featured,
...
insert into public.products
  (slug, name, brand, categories, reference, description, price, offer_price, stock, featured, new_arrival, rating_average, rating_count, attributes, meta_title, meta_description, focus_keyword)
values
  ('edifice-edifice-ecb-2000-bluetooth', 'Edifice ECB-2000 Bluetooth', 'Edifice', '{"mens-watches","digital-watches","analog-watches"}', 'ECB-2000D-1A', 'Edifice''s Bluetooth chronograph links to your phone for world time across 300+ cities, with Tough Solar power and a carbon-look dial.', 108000, 96500, 6, true, true, 4.8, 33, '{"display":"Ana-Digi","style":"Sports","caseColor":"Black","dial":"Black","features":["Chronograph","World Time","Multi-Dial"],"collection":"Edifice ECB"}'::jsonb, 'Edifice Edifice ECB-2000 Bluetooth — Buy Authentic in Sri Lanka', 'Genuine Edifice Edifice ECB-2000 Bluetooth — 100% authentic with full warranty and island-wide delivery in Sri Lanka.', 'edifice-ecb-2000-bluetooth sri lanka')
on conflict (slug) do update set
  name = excluded.name, brand = excluded.brand, categories = excluded.categories,
  reference = excluded.reference, description = excluded.description, price = excluded.price,
  offer_price = excluded.offer_price, stock = excluded.stock, featured = excluded.featured,
...
insert into public.products
  (slug, name, brand, categories, reference, description, price, offer_price, stock, featured, new_arrival, rating_average, rating_count, attributes, meta_title, meta_description, focus_keyword)
values
  ('seiko-5-sports-srpd55-automatic', '5 Sports SRPD55 Automatic', 'Seiko', '{"mens-watches","analog-watches"}', 'SRPD55K3', 'The SRPD55 carries the 5 Sports line''s SKX heritage — a black sunburst dial, day-date at three, and LumiBrite hands that stay legible long after sunset. The 4R36 automatic hand-winds and hacks, and the 100m rating handles a swim without a second thought.', 118000, 94500, 6, true, true, 4.9, 63, '{"display":"Analog","style":"Sports","caseColor":"Black","dial":"Black","features":["Automatic"],"collection":"5 Sports"}'::jsonb, 'Seiko 5 Sports SRPD55 Automatic — Buy Authentic in Sri Lanka', 'Genuine Seiko 5 Sports SRPD55 Automatic — 100% authentic with full warranty and island-wide delivery in Sri Lanka.', '5-sports-srpd55-automatic sri lanka')
on conflict (slug) do update set
  name = excluded.name, brand = excluded.brand, categories = excluded.categories,
  reference = excluded.reference, description = excluded.description, price = excluded.price,
  offer_price = excluded.offer_price, stock = excluded.stock, featured = excluded.featured,
